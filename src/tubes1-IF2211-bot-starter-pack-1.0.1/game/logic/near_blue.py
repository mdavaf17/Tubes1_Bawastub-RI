            ...
            if blue:
                for b in blue:
                    if goal is None:
                        ...
                        if abs(current_position.x - b.position.x) + abs(current_position.y - b.position.y) < abs(current_position.x - goal.x) + abs(current_position.y - goal.y):
                            goal = b.position
            else:
                if properties.diamonds == 4:
                    ...
                    for r in red:
                        if goal is None:
                            ...
                            if abs(current_position.x - r.position.x) + abs(current_position.y - r.position.y) < abs(current_position.x - goal.x) + abs(current_position.y - goal.y):
                                goal = r.position
